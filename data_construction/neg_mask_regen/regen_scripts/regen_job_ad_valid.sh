...
DATA_PATH=$DATA/processed_data/job_ad_regeneration
RESULT_PATH=$DATA/processed_data/job_ad_regeneration_output
USER_DIR=../../../models/regeneration


fairseq-generate $DATA_PATH --gen-subset valid \
    --path /dccstor/autofair/busekorkmaz/cliff_summ/data_construction/neg_mask_regen/bart.large/model.pt --model-overrides '{"arch": "temp_bart_large"}' \
